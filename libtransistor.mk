...
CC_FLAGS := --prefix=$(LIBTRANSISTOR_HOME) -g -fPIC -fexceptions -fuse-ld=lld -fstack-protector-strong -O3 -mtune=cortex-a53 -target aarch64-none-linux-gnu -nostdlib -nostdlibinc $(SYS_INCLUDES) -D__SWITCH__=1 -Wno-unused-command-line-argument
CXX_FLAGS := $(CC_FLAGS) -std=c++17 -stdlib=libc++ -nodefaultlibs -nostdlib++ -nostdinc++ $(CPP_INCLUDES)
AR_FLAGS := rcs
